...
class RickAndMortyStatisticsControllerTest {
    ...
    @Test
    void getSpeciesStatistic_HumanAlive() throws Exception {
        mockRestServiceServer.expect( // Expect a request
                requestTo("https://rickandmortyapi.com/api/character?species=Human&status=alive")  // to this url
